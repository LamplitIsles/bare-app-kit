...
module.exports = exports = class AppKitWindow extends EventEmitter {
  ...
  get hidesOnClose() {
    return binding.windowHidesOnClose(this._handle)
  }

  set hidesOnClose(value) {
    if (typeof value !== 'boolean') throw new TypeError('hidesOnClose must be a boolean')
    binding.windowHidesOnClose(this._handle, value)
  }
  ...
  show() {
    binding.windowShow(this._handle)
    return this
  }
